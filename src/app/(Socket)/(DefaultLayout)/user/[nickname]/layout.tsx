...
export default function UserLayout({ children }: { children: React.ReactNode }) {
    ...
    const Loading = () => {
        return (
            <div className="w-1100px mx-auto max-w-275">
                <Skeleton className="aspect-12/5 h-auto w-275 rounded-lg object-cover" />
                <div className="relative w-full px-6 py-4 sm:flex sm:items-center">
                    <Skeleton
                        circle
                        width={130}
                        height={130}
                        className="absolute -top-25 w-32.5 border-4 border-white sm:-top-7.5 dark:border-[#242526]"
                    />
                    <div className="top-12.5 flex-1">
    ...
    return (
        <div className="min-h-dvh bg-gray-100 pb-4 dark:bg-[#1c1c1d]">
                ...
                {user && currentUser ? (
                    <div className="w-1100px mx-auto max-w-275">
                        <CustomImage
                            ...
                            alt="user"
                            className="aspect-12/5 h-auto w-275 rounded-lg object-cover"
                        ...
                        <div className="mt-0 w-full border-t border-gray-300 px-4 sm:mt-10 dark:border-zinc-700">
                            <Link
                                ...
                                className={cn(
                                    ...
                                    {
                                        'text-primary border-b-primary rounded-br-none rounded-bl-none':
                            ...
                            <Link
                                ...
                                className={cn(
                                    ...
                                    {
                                        'text-primary border-b-primary rounded-br-none rounded-bl-none':
                                            pathname.startsWith('/user') && pathname.endsWith('friends'),
                                    },
                                )}
                            >
                            ...
                            <Link
                                ...
                                className={cn(
                                    ...
                                    {
                                        'text-primary border-b-primary rounded-br-none rounded-bl-none':
                                            pathname.startsWith('/user') && pathname.endsWith('invite'),
                                    },
                                )}
                            >
                                <button className="">Lời mời kết bạn</button>
                            </Link>
                        </div>
                    </div>
                ) : !user && !isLoading ? (
            ...
            <div className="w-1100px mx-auto max-w-275">{children}</div>
        </div>
    )
}
