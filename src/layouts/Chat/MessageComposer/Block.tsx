...
const Block: React.FC<BlockProps> = ({ currentMember }) => {
    ...
    if (currentMember?.deleted_at || !currentMember) {
        return (
            <div className="border-light dark:border-dark-gray flex flex-col gap-1 border-t px-4 py-2 text-center text-black/90 dark:text-gray-300">
            ...
            return (
                <>
                    <ConfirmModal
                        ...
                        confirmText="Bỏ chặn"
                    />
                    <div className="border-light dark:border-dark-gray flex flex-col gap-1 border-t px-4 py-2 pb-4 text-center text-black/90 dark:text-[#e2e5e9]">
